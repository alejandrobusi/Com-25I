// DOM
// document.body.innerText = '<h1> Hello Lisa </h1>';
...
// divContainer.className = 'parrafo';
...
document.body.insertBefore(
  document.createTextNode('Heyy'),
  document.body.chil
)

// eliminar o reemplazar nodos

 let spanDelete = document.getElementById('remover');
...
const getData = async () => {
  ...
  personajes.results.map((personaje) => {
    ...
    contenedor.className = 'card col-3 mx-2 my-2 g-0'
    const card = `
